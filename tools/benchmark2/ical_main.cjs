...
var Duration = /*#__PURE__*/function () {
  ...
  _createClass(Duration, [{
    ...
    value: function fromSeconds(aSeconds) {
      ...
      this.days = trunc(secs / 86400); // If we have a flat number of weeks, use them.
    ...
    value: function fromData(aData) {
      var _iterator = _createForOfIteratorHelper(DATA_PROPS_TO_COPY),
          _step;
...
var Time = /*#__PURE__*/function () {
  ...
  _createClass(Time, [{
    ...
    value: function fromUnixTime(seconds) {
      this.zone = Timezone.utcTimezone;
      var epoch = Time.epochTime.clone();
...
var Timezone = /*#__PURE__*/function () {
  ...
  _createClass(Timezone, [{
    ...
    function fromData(aData) {
      ...
      if (aData instanceof Component$1) {
        ...
        if (aData && "component" in aData) {
          if (typeof aData.component == "string") {
            ...
            this.component = new Component$1(jCal);
          } else if (aData.component instanceof Component$1) {
      ...
      if (this.component instanceof Component$1 && !this.tzid) {
...
_defineProperty(Timezone, "MAX_YEAR", 2035);
...
var TimezoneService = {
  ...
  register: function register(name, timezone) {
    if (name instanceof Component$1) {
...
function updateTimezones(vcal) {
  ...
  for (var _i2 = 0, _Object$entries2 = Object.entries(vtimezones); _i2 < _Object$entries2.length; _i2++) {
  ...
  for (var _i3 = 0, _Object$keys = Object.keys(reqTzid); _i3 < _Object$keys.length; _i3++) {
    var _tzid3 = _Object$keys[_i3];
...
function clone(aSrc, aDeep) {
  if (!aSrc || _typeof(aSrc) != "object") {
    ...
    for (var _i4 = 0, _Object$entries3 = Object.entries(aSrc); _i4 < _Object$entries3.length; _i4++) {
...
var UtcOffset = /*#__PURE__*/function () {
  ...
  _createClass(UtcOffset, [{
    ...
    value: function fromData(aData) {
      if (aData) {
        for (var _i5 = 0, _Object$entries4 = Object.entries(aData); _i5 < _Object$entries4.length; _i5++) {
  ...
  _createClass(RecurIterator, [{
    ...
    value: function init() {
      ...
      if (this.rule.freq == "MONTHLY" && this.has_by_data("BYDAY")) {
        ...
        var daysInMonth = Time.daysInMonth(this.last.month, this.last.year); // Check every weekday in BYDAY with relative dow and pos.

        var _iterator4 = _createForOfIteratorHelper(this.by_data.BYDAY),
            _step4;

        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            var bydow = _step4.value;
            ...
            var dayOfMonth = this.last.nthWeekDay(_dow, pos); // If |pos| >= 6, the byday is invalid for a monthly rule.
        ...
        if (this.last.day < 0) {
          ...
          this.last.day = _daysInMonth2 + this.last.day + 1;
        }
      }
    }
    /**
    ...
    value: function normalizeByMonthDayRules(year, month, rules) {
      var daysInMonth = Time.daysInMonth(month, year); // XXX: This is probably bad for performance to allocate
    ...
    value: function expand_year_days(aYear) {
      ...
      for (var _i6 = 0, _rules = rules; _i6 < _rules.length; _i6++) {
        var part = _rules[_i6];
      ...
      if (partCount == 0) {
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            var _month2 = _step7.value;

            var _daysInMonth5 = Time.daysInMonth(_month2, aYear);

            var _iterator8 = _createForOfIteratorHelper(this.by_data.BYMONTHDAY),
                _step8;

            try {
              for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
                var _monthday = _step8.value;
        ...
        var _iterator9 = _createForOfIteratorHelper(this.by_data.BYMONTH),
            _step9;

        try {
          for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
            var _month3 = _step9.value;
            ...
            if (this.has_by_data("BYSETPOS")) {
              ...
              var _iterator10 = _createForOfIteratorHelper(this.by_data.BYDAY),
                  _step10;

              try {
                for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
                  var coded_day = _step10.value;
        ...
        var _iterator11 = _createForOfIteratorHelper(expandedDays),
            _step11;

        try {
          for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
            var _day4 = _step11.value;
        ...
        var _iterator12 = _createForOfIteratorHelper(_expandedDays),
            _step12;

        try {
          for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
            var _day5 = _step12.value;
        ...
        var _iterator13 = _createForOfIteratorHelper(_expandedDays2),
            _step13;

        try {
          for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
            var _day6 = _step13.value;
    ...
    value: function expand_by_day(aYear) {
      ...
      var _iterator14 = _createForOfIteratorHelper(this.by_data.BYDAY),
          _step14;
    ...
    value: function is_day_in_byday(tt) {
      if (this.by_data.BYDAY) {
        var _iterator15 = _createForOfIteratorHelper(this.by_data.BYDAY),
            _step15;
    ...
    value: function check_contract_restriction(aRuleType, v) {
      ...
      if (aRuleType in this.by_data && ruleMapValue == RecurIterator.CONTRACT) {
        ...
        var _iterator16 = _createForOfIteratorHelper(ruleType),
            _step16;

        try {
          for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
            var bydata = _step16.value;
...
var Recur = /*#__PURE__*/function () {
  ...
  _createClass(Recur, [{
    ...
    value: function toJSON() {
      ...
      for (var _i7 = 0, _Object$entries5 = Object.entries(this.parts); _i7 < _Object$entries5.length; _i7++) {
    ...
    value: function toString() {
      ...
      for (var _i8 = 0, _Object$entries6 = Object.entries(this.parts); _i8 < _Object$entries6.length; _i8++) {
...
var icalValues = extend(commonValues, {
  ...
  recur: {
    ...
    toICAL: function toICAL(data) {
      ...
      for (var _i9 = 0, _Object$entries7 = Object.entries(data); _i9 < _Object$entries7.length; _i9++) {
...
stringify.property = function (property, designSet, noFold) {
  ...
  for (var _i10 = 0, _Object$entries8 = Object.entries(params); _i10 < _Object$entries8.length; _i10++) {
  ...
  _createClass(RecurExpansion, [{
    ...
    value: function _extractDates(component, propertyName) {
      ...
      for (var i = 0, len = props.length; i < len; i++) {
        var _iterator17 = _createForOfIteratorHelper(props[i].getValues()),
            _step17;
...
var Event = /*#__PURE__*/function () {
  ...
  function Event(component, options) {
    ...
    if (component) {
      ...
      this.component = new Component$1('vevent');
    }
...
var ComponentParser = /*#__PURE__*/function () {
  ...
  function ComponentParser(options) {
    ...
    _defineProperty(this, "ontimezone",
    /* c8 ignore next */
    function (component) {});

    _defineProperty(this, "onevent",
    /* c8 ignore next */
    function (component) {});
    ...
    for (var _i11 = 0, _Object$entries9 = Object.entries(options); _i11 < _Object$entries9.length; _i11++) {
  ...
  _createClass(ComponentParser, [{
    ...
    function process(ical) {
      ...
      if (!(ical instanceof Component$1)) {
        ical = new Component$1(ical);
      }
